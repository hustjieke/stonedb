...
class ValueParserForText {
 public:
  ...
  static auto GetParsingFuntion(const core::AttributeTypeInfo &at)
    ...
    switch (at.Type()) {
      ...
      case common::ColumnType::INT:
        return std::bind<common::ErrorCode>(&ParseNumeric, std::placeholders::_1, std::placeholders::_2, at.Type(), at.GetUnsignedFlag());
  ...
  static common::ErrorCode ParseNumeric(BString const &tianmu_s, int64_t &out, common::ColumnType at, bool unsigned_flag);
  ...
  static common::ErrorCode Parse(const BString &tianmu_s, TianmuNum &tianmu_n, common::ColumnType at, bool unsigned_flag = false);
