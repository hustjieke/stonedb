...
common::ErrorCode ValueParserForText::Parse(const BString &tianmu_s, TianmuNum &tianmu_n, common::ColumnType at, bool unsigned_flag) {
...
common::ErrorCode ValueParserForText::ParseNumeric(BString const &tianmu_s, int64_t &out, common::ColumnType at, bool unsigned_flag) {
  TianmuNum number;
