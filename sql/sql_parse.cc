        ...
        */
                                             ...
                                             select_tables)))
        {
          ...
          */
		  ...
		  if (Tianmu::dbhandler::SDB_HandleSelect(thd, lex, result, 0, sdb_res, optimize_after_sdb, free_join_from_sdb, (int)true) == 0)
  ...
  */
  ...
  case SQLCOM_SET_OPTION:
  {
    ...
    if ((check_table_access(thd, SELECT_ACL, all_tables, FALSE, UINT_MAX, FALSE)
      ...
      goto error;
	if (!Tianmu::dbhandler::SDB_SetStatementAllowed(thd, lex)) {
		goto error;
	}
  ...
  if (!(res= open_tables_for_query(thd, all_tables, 0)))
  {
    ...
    if (lex->is_explain())
    {
      ...
      */
      ...
      res= handle_query(thd, lex, result, (ulonglong)0, (ulonglong)0, 0, 0);
    }
    else
    {
	  ...
	  if (Tianmu::dbhandler::SDB_HandleSelect(thd, lex, result, (ulong)0,
