...
--
-- ADD SYS_TIANMU DATABASE
-- Tianmu UPGRADE
--
SET @cmd= "DROP DATABASE IF EXISTS sys_tianmu";
...
SET @cmd= "CREATE DATABASE sys_tianmu character set utf8";
